...
Dialog.prototype.show = function () {
    ...
    arr.push("    <td width='13' height='33' style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_lt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_lt.png', sizingMethod='crop');\"><div style='width:13px;'></div></td>");
    arr.push("    <td height='33' style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_ct.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_ct.png', sizingMethod='crop');\"><div style=\"float:left;font-weight:bold; color:#FFFFFF; padding:9px 0 0 4px;\"><img src=\"" + Server.ContextPath + "js/Images/icon_dialog.gif\" align=\"absmiddle\">&nbsp;<span id='_DialogTitle'>" + this.Title + "</span></div>");
    arr.push("      <div style=\"position: relative;cursor:pointer; float:right; margin:5px 0 0; _margin:4px 0 0;height:17px; width:28px; background-image:url(" + Server.ContextPath + "js/Images/dialog_closebtn.gif)\" onMouseOver=\"this.style.backgroundImage='url(" + Server.ContextPath + "js/Images/dialog_closebtn_over.gif)'\" onMouseOut=\"this.style.backgroundImage='url(" + Server.ContextPath + "js/Images/dialog_closebtn.gif)'\" drag='false' onClick=\"Dialog.getInstance('" + this.ID + "').CancelButton.onclick.apply(Dialog.getInstance('" + this.ID + "').CancelButton,[]);\"></div></td>");
    arr.push("    <td width='13' height='33' style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_rt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_rt.png', sizingMethod='crop');\"><div style=\"width:13px;\"></div></td>");
    arr.push("  </tr>");
    arr.push("  <tr drag='false'><td width='13' style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_mlm.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_mlm.png', sizingMethod='crop');\"></td>");
    ...
    arr.push("          <td height='50' valign='top'><table id='_MessageTable_" + this.ID + "' width='100%' border='0' cellspacing='0' cellpadding='8' style=\" background:#EAECE9 url(" + Server.ContextPath + "js/Images/dialog_bg.jpg) no-repeat right top;\">");
    arr.push("              <tr><td width='25' align='right'><img id='_MessageIcon_" + this.ID + "' src='" + Server.ContextPath + "js/Images/window.gif' width='32' height='32'></td>");
    ...
    arr.push("    <td width='13' style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_mrm.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_mrm.png', sizingMethod='crop');\"></td></tr>");
    arr.push("  <tr><td width='13' height='13' style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_lb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_lb.png', sizingMethod='crop');\"></td>");
    arr.push("    <td style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_cb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_cb.png', sizingMethod='crop');\"></td>");
    arr.push("    <td width='13' height='13' style=\"background-image:url(" + Server.ContextPath + "js/Images/dialog_rb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + Server.ContextPath + "js/Images/dialog_rb.png', sizingMethod='crop');\"></td>");
    arr.push("  </tr></table>");
    this.TopWindow = pw;
...
Dialog.prototype.close = function () {
    if (this.WindowFlag) {
        ...
        if (this.AlertFlag) {
            ...
            if (this.Animator) {
                pw.Effect.fade(pw.$("_AlertBGDiv"), 3, 0, 0.5, pw._OpacityFunc);
            } else {
                pw._OpacityFunc();
            }
        }
...
Dialog.alert = function (msg, func, w, h) {
    ...
    arr.push("<tr><td align='right'><img id='Icon' src='" + Server.ContextPath + "js/Images/icon_alert.gif' width='34' height='34' align='absmiddle'></td>");
...
Dialog.confirm = function (msg, func1, func2, w, h) {
    ...
    arr.push("<tr><td align='right'><img id='Icon' src='" + Server.ContextPath + "js/Images/icon_query.gif' width='34' height='34' align='absmiddle'></td>");
    arr.push("<td align='left' id='Message' style='font-size:9pt'>" + msg + "</td></tr></table>");
    var div = doc.createElement("div");
    div.innerHTML = arr.join('');
    doc.body.appendChild(div);
