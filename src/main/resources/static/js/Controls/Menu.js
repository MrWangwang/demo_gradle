        ...
        for (var i = 0; i < this.Items.length; i++) {
            ...
            if (true == this.Items[i][3]) {//表示这个菜单项是否灰掉
                ...
                if (this.Items[i][2]) {
                    ...
                    html.push("<td height='22' width='24' align='center' valign='middle' style='background:#DDF;'><img src='" + Server.ContextPath + "js/Images/blank.gif' width='20' height='20' hspace='2' vspace='1'/></td>");
                }
