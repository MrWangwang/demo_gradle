...
for(var i=0;i<scripts.length;i++){
	if(/main\.js$/img.test(scripts[i].getAttribute("src"))){
		var jsPath = scripts[i].getAttribute("src").replace(/js\/auditor\/main\.js$/img,'');
...
Afloat=function(id){
	...
	this.init();
	var me=this;
	window.attachEvent("onscroll",function(evt){me.setPosition();})
}
Afloat.prototype={
	init:function(){
		this.dom.style.position="static";
		this.fixY=Math.round(this.dom.getPosition().y);
	...
	setPosition:function(){
		...
		if(st+this.viewportH<this.fixY){
			if(isIE6){
				this.dom.style.position="absolute";
				this.dom.style.top=st+this.viewportH-this.height+'px';
			}else{
...
var downSelect = function() {
	jQuery("select[ztype='DownSelect']").flexselect();
}

/*START_LOADSCRIPT*/
//Server.loadScript("js/auditor/jquery.js");
Server.loadScript("js/jquery.validationEngine.js");
Server.loadScript("js/jquery.validationEngine-zh_CN.js");
Server.loadScript("js/auditor/common.js");
Server.loadScript("js/Drag.js");
Server.loadScript("js/Controls/Tabpage.js");
Server.loadScript("js/Controls/Select.js");
Server.loadScript("js/Controls/Dialog.js");
Server.loadScript("js/Controls/MessagePop.js");
Server.loadScript("js/Controls/DataGrid.js");
Server.loadScript("js/Controls/DataList.js");
Server.loadScript("js/Controls/Menu.js");
Server.loadScript("js/Controls/DateTime.js");
Server.loadScript("js/Controls/Tree.js");
Server.loadScript("js/Controls/Tip.js");
Server.loadScript("js/Controls/Progress.js");
Server.loadScript("js/Application.js");
Server.loadScript("js/Verify.js");
Server.loadScript("js/Style.js");
Server.loadScript("js/Resize.js");
Server.loadScript("js/Console.js");
Server.loadScript("js/Paging.js");
Server.loadScript("js/Server.js");
/*END_LOADSCRIPT*/
